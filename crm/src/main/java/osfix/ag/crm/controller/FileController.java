...
import osfix.ag.crm.exceptions.FileResponse;
import osfix.ag.crm.service.impl.FileService;
...
public class FileController {
    ...
    public FileResponse uploadFile(@RequestParam("file") MultipartFile file) {
        ...
        String fileUri = ServletUriComponentsBuilder.fromCurrentContextPath().path("/download/").
                path(model.getFileId().toString()).toUriString();
    ...
    public ResponseEntity<Resource> downloadFile(@PathVariable Long fileName) {
