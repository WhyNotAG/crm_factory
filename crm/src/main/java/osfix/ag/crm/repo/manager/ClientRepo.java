...
//    Page<Client> findAllByCategory_NameAndClientTypeAndTypeAndUser(String name, String clientType, String type, User user, Pageable pageable);
    ...
    Set<Client> findAllByNameIgnoreCaseContainsAndTypeOrCommentIgnoreCaseContainsAndTypeOrSiteIgnoreCaseContainsAndTypeOrSiteContainsAndTypeOrPriceIgnoreCaseContainsAndType
